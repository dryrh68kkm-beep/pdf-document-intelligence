"""Dashboard division rollup tests using a runtime-generated test hierarchy."""
...
def test_unmapped_department_returns_none_not_a_new_division():
    ...
    names = {name for _, name in get_default_divisions()}
...
def test_no_department_maps_to_more_than_one_division():
    ...
    path = Path(os.environ["PDF_INTELLIGENCE_MASTER_CATALOG"])
    seen: dict[str, str] = {}
